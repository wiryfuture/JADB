...
const loadcommands_1 = require("./misc/loadcommands");
const prefix = "!";
const client = new discord_js_1.Client();
client.login(process.env.JADB_BOT_TOKEN);
const commands = loadcommands_1.loadCommands();
...
client.on("message", async (message) => { onmessage_1.onMessage(client, prefix, commands, message); });
